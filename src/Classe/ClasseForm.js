...
class ClasseForm extends React.Component
{
    ...
    SisManterExcluir(entidade)
    {
        ...
        axios.get(process.env.REACT_APP_SERVER_URL + "/api/classe/excluir/" + entidade.id
            ,window.getCabeca())
    ...
    SisManterSalvar(entidade)
    {
        ...
        if(entidade.id==0)
        {
            axios.post(process.env.REACT_APP_SERVER_URL + "/api/classe/salvar"
                ,entidade
                ,window.getCabeca()
            )
    ...
    SisManterConsultar(entidade)
    {
        ...
        axios.get(process.env.REACT_APP_SERVER_URL + "/api/classe/consultar/" + entidade.id
            ,window.getCabeca()
            )
