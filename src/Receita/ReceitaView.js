...
import ReceitaPesquisa from './ReceitaPesquisa';
...
class ReceitaView extends React.Component
{
    constructor(props)
    {
        ...
        this.state={visao:"pesquisar"
            ...
            ,processando:false
            ,url:{
                pesquisar:process.env.REACT_APP_SERVER_URL + "/api/receita/pesquisar"
               ,salvar:process.env.REACT_APP_SERVER_URL + "/api/receita/salvar"
               ,consultar:process.env.REACT_APP_SERVER_URL + "/api/receita/consultar/"
               ,excluir:process.env.REACT_APP_SERVER_URL + "/api/receita/excluir/"
           }
