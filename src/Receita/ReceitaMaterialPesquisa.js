...
class ReceitaMaterialPesquisa extends React.Component
{
    constructor(props)
    {
        super(props);
    ...
    SisManterPesquisar(entidade)
    {
        ...
        axios.get(process.env.REACT_APP_SERVER_URL + "/api/receitamaterial/pesquisar" + p
            ,window.getCabeca()
        )
...
export default ReceitaMaterialPesquisa;
